...
SECRET_KEY = ')06l#-ncapgiys095j%27d#kyaxa@zv^ab!&q5l&c702$$fus&'
...
COVERAGE_EXCLUDE_MODULES = (
    'medicalCare.migrations',
    'medicalCare.tests',
    'medicalCare.local_settings',
    'opal.migrations',
    'opal.tests',
    'opal.wsgi',
)
...
DEFAULT_DOMAIN = 'http://medicalCare.com/'


# ========== PROJECT ==========
OPAL_BRAND_NAME = 'medicalCare'
